local function mg_fire(ply,vehicle,shootOrigin,shootDirection)
	...
	local projectile = {}
		...
		projectile.HullSize = 25
		projectile.attackingent = vehicle
		projectile.Spread = Vector(0.02,0.02,0.02)
...
function simfphys.weapon:PrimaryAttack( vehicle, ply )
	...
	ParticleEffectAttach( "simfphys_cursed_halo_ce_megahog_muzzle", PATTACH_POINT_FOLLOW, vehicle, 6 )
