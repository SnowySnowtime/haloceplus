...
function simfphys.weapon:Initialize( vehicle )
	...
	data.Attach_Start_Left = "muzzlel"
	data.Attach_Start_Right = "muzzler"
	data.Type = 3
...
function simfphys.weapon:PrimaryAttack( vehicle, ply )
	...
	local AttachmentID = vehicle:LookupAttachment( "muzzlel" )
	...
	ParticleEffectAttach( "simphys_halo_scorpion_chaingun_muzzle", PATTACH_POINT_FOLLOW, vehicle, 7 )
	
	mg_fire( ply, vehicle, shootOrigin, shootDirection )
	
	self:SetNextPrimaryFire( vehicle, CurTime() + 0.035 )
end
