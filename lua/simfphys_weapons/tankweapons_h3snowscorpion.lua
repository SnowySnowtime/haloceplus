...
function simfphys.weapon:ValidClasses()
	...
	local classes = {
		"simfphys_h3scorpionsnow",
		"simfphys_h3sfscorpionsnow"
	}
...
function simfphys.weapon:Initialize( vehicle )
	net.Start( "halo_misc_register_tank" )
		...
		net.WriteString( "h3scorpionsnow" )
	net.Broadcast()
	local data = {}
...
function simfphys.weapon:PrimaryAttack( vehicle, ply, shootOrigin, Attachment )
	...
	ParticleEffectAttach( "simphys_halo_scorpion_muzzle", PATTACH_POINT_FOLLOW, vehicle, 2 )
