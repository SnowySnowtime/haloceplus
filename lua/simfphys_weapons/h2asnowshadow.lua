local function m1(ply,vehicle,shootOrigin,shootDirection)
	vehicle:EmitSound( "phantom_fire" )
...
function simfphys.weapon:ValidClasses()
	...
	local classes = {
		"simfphys_covshadowsnow",
		"simfphys_covshadowghostsnow",
...
function simfphys.weapon:Initialize( vehicle )
	local data = {}
	vehicle.pSeat[1]:SetParent(vehicle,vehicle:LookupAttachment("muzzle"))
	data.Attachment = "player"
	data.Direction = Vector(1,0,0)
	data.Attach_Start_Left = "player"
	data.Attach_Start_Right = "player"
	data.Type = 3

	simfphys.RegisterCrosshair( vehicle.pSeat[1] , { Attachment = "player", Type = 2 } )

	simfphys.RegisterCrosshair( vehicle.pSeat[1] , { Attachment = "muzzle", Type = 5 } )
	simfphys.RegisterCamera( vehicle.pSeat[1], Vector(50,-50,21.75), Vector(0,10,60), true, "camera" )
...
function simfphys.weapon:PrimaryAttack( vehicle, ply )
	...
	local AttachmentID = vehicle:LookupAttachment( "player" )
