...
SWEP.PrintName			= "Legends Sword"
SWEP.WepSelectIcon 		= "vgui/entities/drchalo_sword"

SWEP.Manufacturer		= "Halo Legends"
SWEP.InfoDescription	= "A sword deployed by Haka."
...
SWEP.UseHands		= true
SWEP.ViewModel 		= "models/snowysnowtime/dsb/c_legendsblade.mdl"
SWEP.WorldModel 	= "models/snowysnowtime/dsb/w_legendssword.mdl"
...
SWEP.Primary.LungeDelayMiss		= 1.5
SWEP.Primary.LungeDelayHit		= 1
SWEP.Primary.LungeHitDelay		= 0.8
SWEP.Primary.LungeDamage		= 128
