...
SWEP.UseHands			= true
SWEP.ViewModel 			= "models/snowysnowtime/drc/pistols/c_lumoria_m6socom.mdl"
SWEP.WorldModel			= "models/snowysnowtime/drc/pistols/w_lumoria_pistol.mdl"
