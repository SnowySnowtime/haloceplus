...
SWEP.InfoName			= "Assault Rifle - SPV3"
SWEP.InfoDescription	= "The MA5E Assault Rifle is an automatic assault rifle designed for both mid-range and close-quarters combat. As the latest in the MA5 series of\nassault rifles, it shares many similarities with previous models, including shape, magazine size, and integrated ammo counter/compass display."
...
SWEP.UseHands			= true
SWEP.ViewModel 			= "models/snowysnowtime/drc/c_fp_cmtar.mdl"
SWEP.WorldModel			= "models/snowysnowtime/drc/w_fp_cmtar.mdl"
