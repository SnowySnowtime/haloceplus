...
SWEP.UseHands			= true
SWEP.ViewModel 			= "models/snowysnowtime/dsb/ho/c_hum_ho_car_rng.mdl"
SWEP.WorldModel			= "models/snowysnowtime/dsb/ho/w_ho_car_rng.mdl"
...
SWEP.Primary.Kick			= 2
SWEP.Primary.RecoilUp		= 1.5
SWEP.Primary.RecoilDown		= 0.6
SWEP.Primary.RecoilHoriz	= 40
...
SWEP.Primary.Sound 			= Sound("snow.ho_rng_car")
