...
SWEP.UseHands			= true
SWEP.ViewModel 			= "models/snowysnowtime/dsb/ho/c_hum_ho_car_dmg.mdl"
SWEP.WorldModel			= "models/snowysnowtime/dsb/ho/w_ho_car_dam.mdl"
...
SWEP.Primary.Sound 			= Sound("snow.ho_dmg_car")
