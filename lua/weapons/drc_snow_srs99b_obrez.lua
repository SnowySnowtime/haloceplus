...
SWEP.PrintName			= "SRS99B Obrez"
SWEP.WepSelectIcon 		= "vgui/entities/drchalo_sniper"

SWEP.Manufacturer		= "Misriah Armory"
SWEP.InfoName			= "Bullpup Sniper Rifle Obrez"
SWEP.InfoDescription	= "Semi-auto, gas-operated, bullpupped, mid to mid-long range general purpose sniper rifle.\n With a shortened barrel. Fuck you."
...
SWEP.UseHands			= true
SWEP.ViewModel = 		"models/snowysnowtime/dsb/c_mifl_custom_bullpup_srs99.mdl"
SWEP.WorldModel			= "models/snowysnowtime/dsb/w_mifl_custom_bullpup_srs99.mdl"
