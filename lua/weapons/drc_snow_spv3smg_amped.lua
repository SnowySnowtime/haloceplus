...
SWEP.UseHands			= true
SWEP.ViewModel = 		"models/snowysnowtime/drc/c_smg_amped.mdl"
SWEP.WorldModel			= "models/snowysnowtime/drc/w_smg_amped.mdl"
...
SWEP.Primary.Spread			= 7.5
SWEP.Primary.SpreadDiv		= 60
SWEP.Primary.Kick			= 0.4
SWEP.Primary.RecoilUp		= 0.55
SWEP.Primary.RecoilDown		= 0.33
SWEP.Primary.RecoilHoriz	= 29
SWEP.Primary.Force			= 0.22
