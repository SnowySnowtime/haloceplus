...
SWEP.PrintName			= "Type-1 Bloodblade"
SWEP.WepSelectIcon 		= "vgui/entities/drchalo_sword"

SWEP.Manufacturer		= "Assembly Forges"
SWEP.InfoDescription	= "A corrupted variant of the Energy Sword employed by the spartan hunter operatives named the Silent Shadow.\nIt is sometimes used in the UNSC's War Games simulator."
...
SWEP.UseHands		= true
SWEP.ViewModel 		= "models/snowysnowtime/dsb/c_infectedsword.mdl"
SWEP.WorldModel 	= "models/snowysnowtime/dsb/w_infectedsword.mdl"
...
SWEP.Primary.LungeDelayMiss		= 1.6
SWEP.Primary.LungeDelayHit		= 0.8
SWEP.Primary.LungeHitDelay		= 0.2
SWEP.Primary.LungeDamage		= 60
