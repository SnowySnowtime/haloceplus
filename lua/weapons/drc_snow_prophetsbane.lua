...
SWEP.PrintName			= "Type-1 Prophets Bane"
SWEP.WepSelectIcon 		= "vgui/entities/drchalo_sword"

SWEP.Manufacturer		= "Assembly Forges"
SWEP.InfoDescription	= "A varaiant of the Type-1 Energy Weapon/Sword weilded exclusively by the Arbiter of the Swords of Sangheilios."
...
SWEP.UseHands		= true
SWEP.ViewModel 		= "models/snowysnowtime/dsb/c_prophetsbane.mdl"
SWEP.WorldModel 	= "models/snowysnowtime/dsb/w_prophetsbane.mdl"
...
SWEP.Glow = true
SWEP.GlowColor		= Color(200, 120, 80)
