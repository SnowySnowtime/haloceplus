...
SWEP.PrintName			= "Type-1 Floatyboi"
SWEP.WepSelectIcon 		= "vgui/entities/drchalo_sword"

SWEP.Manufacturer		= "Assembly Forges"
SWEP.InfoDescription	= "The Type-1 Floatyboi was smithed with a different technique than the Type-1 Energy Weapon/Sword. However, it does not make this blade superior to the sword."
...
SWEP.UseHands		= true
SWEP.ViewModel 		= "models/snowysnowtime/dsb/c_segmentedblade.mdl"
SWEP.WorldModel 	= "models/snowysnowtime/dsb/w_segmentedblade.mdl"
...
SWEP.Glow = true
SWEP.GlowColor		= Color(200, 130, 255)
