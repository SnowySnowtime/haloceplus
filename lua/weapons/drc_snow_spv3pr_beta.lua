...
SWEP.PrintName			= "Type-25 Proto-DER"
SWEP.InfoName			= "Plasma Rifle - SPV3 Alpha"
SWEP.Author				= "Snowy Snowtime"
SWEP.Contact			= "Steam: Snowy Snowtime\nDiscord: Snowy Snowtime#6018"

SWEP.Manufacturer		= "Iruiru Armory"
SWEP.InfoDescription	= "A prototype variant of the Type-25 DER commonly seen.\nDespite this, it is funcitonally identical to the later variants, seemingly due to preference."
...
SWEP.UseHands			= true
SWEP.ViewModel			= "models/snowysnowtime/drc/c_spv3pr_alpha.mdl"
SWEP.WorldModel			= "models/snowysnowtime/drc/w_spv3pr_alpha.mdl"
