...
SWEP.PrintName			= "BR85-A58"
SWEP.InfoName			= "Battle Rifle - Accuracy"
...
SWEP.UseHands			= true
SWEP.ViewModel = 		"models/snowysnowtime/drc/ho/c_br_acc.mdl"
SWEP.WorldModel			= "models/snowysnowtime/drc/ho/w_br_acc.mdl"
...
SWEP.Primary.Sound 			= Sound("drc.HaloOnline_BR_Accuracy")
	...
	if CLIENT then
		self.VElements["ammo_counter"].draw_func = function( weapon )
			if self:Clip1() < 10 then
				draw.SimpleText("0".. self:Clip1() .."", "343_ammocounter", 0, 8.5, Color(0,255,0,255), TEXT_ALIGN_CENTER, TEXT_ALIGN_BOTTOM)
			else
				draw.SimpleText(self:Clip1(), "343_ammocounter", 0, 8.5, Color(0,200,0,255), TEXT_ALIGN_CENTER, TEXT_ALIGN_BOTTOM)
			end
		end
		
		self.VElements["ammo_counter_00"].draw_func = function( weapon )
			draw.SimpleTextOutlined("00", "343_ammocounter", 0, 8.5, Color(0,255,0,255), TEXT_ALIGN_CENTER, TEXT_ALIGN_BOTTOM, 2, Color(115, 186, 214,150))
		end
	end
end