...
SWEP.InfoName			= "Plasma Rifle - SPV3"
...
SWEP.UseHands			= true
SWEP.ViewModel			= "models/snowysnowtime/drc/c_spv3pr.mdl"
SWEP.WorldModel			= "models/snowysnowtime/drc/w_spv3pr.mdl"
SWEP.VMPos 				= Vector(0.5, 1, 0.1)
...
SWEP.Primary.Sound 			= Sound("pr_hcea_fire")
