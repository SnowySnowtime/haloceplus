...
SWEP.PrintName			= "Type-1 Infected Sword"
SWEP.WepSelectIcon 		= "vgui/entities/drchalo_sword"

SWEP.Manufacturer		= "Assembly Forges"
SWEP.InfoDescription	= "An Infected variant of the Energy Sword, employed for the UNSC's War Games simulator for Infection sessions."
...
SWEP.UseHands		= true
SWEP.ViewModel 		= "models/snowysnowtime/dsb/c_infectionsword.mdl"
SWEP.WorldModel 	= "models/snowysnowtime/dsb/w_infectionsword.mdl"
