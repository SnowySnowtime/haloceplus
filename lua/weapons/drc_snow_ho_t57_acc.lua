...
SWEP.UseHands			= true
SWEP.ViewModel 			= "models/snowysnowtime/dsb/ho/c_hum_ho_car_acc.mdl"
SWEP.WorldModel			= "models/snowysnowtime/dsb/ho/w_ho_car_acc.mdl"
...
SWEP.Primary.Sound 			= Sound("snow.ho_acc_car")
