...
game.AddParticles( "particles/simfphys_haloce_muzzle_effects.pcf" )
PrecacheParticleSystem( "simphys_halo_warthog_chaingun_muzzle" )
PrecacheParticleSystem( "simphys_halo_warthog_gauss_muzzle" ) 
PrecacheParticleSystem( "simphys_halo_warthog_rocket_muzzle" ) 
PrecacheParticleSystem( "simphys_halo_scorpion_muzzle" ) 
PrecacheParticleSystem( "simphys_halo_scorpion_chaingun_muzzle" ) 
PrecacheParticleSystem( "simfphys_cursed_halo_ce_megahog_muzzle" ) 
PrecacheParticleSystem( "simfphys_halo_ce_scorpion_muzzle" ) 
PrecacheParticleSystem( "simfphys_halo_warthog_ce_chaingun_muzzle" ) 
