...
function EFFECT:Init( data )
	...
	for i = 0,50 do
		...
		if particle then
			...
			particle:SetGravity( Vector( 255, 255, 255 ) )
	...
	sound.Play( "hornet_expl_h3", self.Pos, 95, 140, 1 )
end
...
function EFFECT:Render()
	...
	render.DrawSprite( self.Pos, 2000 * Scale, 2000 * Scale, Color( 255, 200, 20, 255) )
end