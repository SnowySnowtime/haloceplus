function EFFECT:Init( data )
	...
	if random == 1 then
		sound.Play( "halo/halo_reach/weapons/rocket_expl1.ogg", Pos, 95, 100, 1 )
	elseif random == 2 then
		sound.Play( "halo/halo_reach/weapons/rocket_expl4.ogg", Pos, 95, 140, 1 )
	else
		sound.Play( "halo/halo_reach/weapons/rocket_expl6.ogg", Pos, 95, 100, 1 )
	end
end
