function EFFECT:Init( data )
	...
	for i = 1,3 do
		...
		if (particle2) then
			...
			particle2:SetLifeTime(math.Rand(0.05, 0.05)) 
		...
		if (particle2) then
			particle2:SetVelocity((-self.Normal+VectorRand() * 1):GetNormal() * math.Rand(35, 225));
			particle2:SetLifeTime(math.Rand(0.05, 0.1)) 
			particle2:SetDieTime(0.5) 
			particle2:SetStartAlpha(255)
		...
		if (particle2) then
			...
			particle2:SetLifeTime(math.Rand(0.05, 0.03)) 
			particle2:SetDieTime(math.Rand(1, 1)) 
			particle2:SetStartAlpha(255)
			particle2:SetEndAlpha(0)
			particle2:SetStartSize(math.Rand(3, 3)) 
			particle2:SetEndSize(0)
			particle2:SetAngleVelocity( Angle(4.2934407040912,14.149586106307,0.18606363772742) ) 
			particle2:SetRoll(math.Rand( 0, 360 ))
