...
EFFECT.TailMat				= "effects/draconic_halo/hunter_beam"

EFFECT.MuzzleEffect		= "drc_halo_partc_flash"
EFFECT.ImpactEffect		= "drc_halo_partc_impact"
...
function EFFECT:Init(data)
	...
	timer.Simple(self.LifeTime, function() sound.Play("drc.cov_carbine_impact", data:GetStart()) end)
...
function EFFECT:Render()
	...
	if self.DoTracer == true then
		...
		render.DrawSprite(endPos, 20, 20, Color(self.TracerColor.r, self.TracerColor.g, self.TracerColor.b))
