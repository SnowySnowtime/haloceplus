...
function ENT:AnimFins()
	...
	self:ManipulateBoneAngles( 3, Angle( 0,self.smYaw / 1,0) )
	self:ManipulateBoneAngles( 6, Angle( 0,self.smYaw / 1,0) )
	self:ManipulateBoneAngles( 9, Angle( 0,self.smYaw / 1,0) )
	self:ManipulateBoneAngles( 10, Angle( 0,self.smYaw / 1,0) )
