...
function ENT:Initialize()
    if SERVER then
	 util.SpriteTrail( self, 0, Color(255,255,255,155), false, 10, 0, 1.2, 1, "trails/smoke" )
...
function ENT:Detonate()
    if SERVER then
        ...
        if self:WaterLevel() >= 1 then
            ...
            util.Effect( "effect_simfphys_halo_scorpion_projectile_explosion_hce", effectdata)
